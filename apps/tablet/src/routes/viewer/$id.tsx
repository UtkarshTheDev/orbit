  ...
  return (
    <div className="flex h-screen w-screen overflow-hidden bg-slate-900">
      ...
      <div className="relative flex-1">
        ...
        >
          <Button
            className="h-16 w-16 rounded-full bg-white/90 shadow-lg backdrop-blur-sm transition-all hover:bg-white hover:shadow-xl"
        ...
        >
          ...
          <div className="flex flex-col items-center justify-center gap-2 rounded-xl border border-slate-700/30 bg-slate-800/40 px-4 py-2.5 font-sans text-slate-300 text-xs backdrop-blur-md sm:flex-row sm:gap-4 md:text-sm">
      ...
      {!sidebarOpen && (
        ...
        >
          <Button
            className="h-12 w-12 rounded-full bg-white/90 shadow-lg backdrop-blur-sm transition-all hover:bg-white hover:shadow-xl"
