...
const StatusText = ({ state }: StatusTextProps) => {
		...
		switch (state) {
			...
			case "uploading":
				return (
					<span className="flex items-center gap-2">
						<ShimmeringText text="Processing audio" className="text-blue-600" />
			...
			case "thinking":
				return (
					<span className="flex items-center gap-2">
						<ShimmeringText
							text="Thinking about your query"
							className="text-blue-600"
						/>
						<span className="flex gap-0.5">
							<span className="dot-pulse-1">•</span>
	...
	return (
		<div className="absolute bottom-16 md:bottom-20 left-1/2 transform -translate-x-1/2 z-10 animate-fade-in">
			<p
				className="font-orbitron font-medium text-sm md:text-base tracking-wide"
